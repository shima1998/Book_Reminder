...
userLists = client.query("SELECT * FROM test_book1;")
...
EOS
  ...
  print "{\n"
  print "\"ID\": " + "\"" + 0  + "\",\n"
  print "\"name\": " + "\"" + checkUser.to_s  + "\",\n"
  print "\"status\": " + "\"" + checkUser.to_s + "\",\n"
  print "\"reviewName\": " + "\"" + checkUser.to_s + "\",\n"
  print "\"reviewPoint\": " + "\"" + checkUser.to_s + "\",\n"
  print "\"date\": " + "\"" + checkUser.to_s + "\"\n"
  print "},\n"
  print "{}]\n"
else
  print <<-EOS
